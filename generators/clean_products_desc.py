...
def generate_description(index):
    ...
    Create an engaging product description in 50 words for the product listed above, make it professional
    Assistant:
    """
...
def generate_title(index):
    ...
    create a one line product name for the product in 5 to 10 words listed above for a generic e-commerce website,  make it professional
    Assistant:
    """
